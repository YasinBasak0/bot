...
const Container = props => {
  return (
    <PageContainer
      ...
      helpText={
        <span>
          This is a checklist of recommended settings when running Qbot in production.
  ...
  return (
    <Container>
      <div className="checklist">
        <Item
          title="Enable Qbot Professional"
        ...
        >
          Qbot Pro provides multiple features ready to be used in an enterprise-grade solution.
        </Item>
        ...
        >
          <span>
            ...
            When it is not set, it defaults to http://localhost:7890. When using Qbot Professional, this value is
